...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Helder Gonçalves"
    user-mail-address "goncalves.helder@proton.me")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/heldergoncalves/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/heldergoncalves/bin" "/profile/bin" "/Users/heldergoncalves/.npm-packages/bin" "/Users/heldergoncalves/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
